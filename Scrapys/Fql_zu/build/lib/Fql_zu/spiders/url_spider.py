...
class AnjukeUrlSpiderSpider(scrapy.Spider):
    ...
    custom_settings = {
        "ITEM_PIPELINES": {
            'Fql_zu.pipelines.DiplicatesPipeline': 200,
            'Fql_zu.pipelines.URLDBPipeline': 300
        },
