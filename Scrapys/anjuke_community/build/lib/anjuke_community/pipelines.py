...
class DiplicatesPipeline(object):
    ...
    def __init__(self):
        ...
        if redis_db.hlen(redis_data_dict) == 0:
            sql= "SELECT id FROM anjuke_community"
...
class DbPipeline(object):
    def process_item(self,item,spider):
        ...
        try:
            cue.execute("INSERT INTO anjuke_community(id,title,address,link) VALUES (%s,%s,%s,%s)",(item['id'],item['title'],item['address'],item['link']))
            print("insert succes")
